...
cNoGP			 con 1		; turn of GP player
cNoSL			 con 1		; turn off single leg control
...
cXXFemurHornOffset	con 0 ;Default no servo horn offsets
...
cXXCoxaLength   con 29      ;1.14" = 29mm (1.14 * 25.4)
cXXFemurLength  con 76     	;2.98" = 76mm (2.98 * 25.4)
cXXTibiaLength  con 104    	;4.04" = 103mm (4.04 * 25.4)
cXXTarsLength	con	85		;4DOF ONLY - Lenght of the Tars [mm]
...
cHexInitPosY   	con 26	   ;Global start hight
cHexInitXZ		con 105		
